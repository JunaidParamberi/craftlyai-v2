...
export default function InvoiceEmail({
  ...
  return (
    <Html lang="en">
      ...
      <Preview>
        Invoice {invoiceNumber} from {businessName} — {fmt(total, currency)} due
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            ...
            <Text style={styles.body_text}>
              Please find your invoice details below. You can pay securely
              online using the button at the bottom of this email.
            </Text>

            {(formattedDueDate ?? paymentTerms) && (
              <Section style={styles.metaRow}>
                {formattedDueDate && (
                  <Row>
                    <Column style={styles.metaLabel}>
                      <Text style={styles.metaLabelText}>Due Date</Text>
                    </Column>
                ...
                {paymentTerms && (
                  <Row>
                    <Column style={styles.metaLabel}>
                      <Text style={styles.metaLabelText}>Payment Terms</Text>
                    </Column>
                    <Column style={styles.metaValue}>
                      <Text style={styles.metaValueText}>{paymentTerms}</Text>
                    </Column>
                  </Row>
                )}
              </Section>
            ...
            <Row style={styles.totalsRow}>
              ...
              <Column style={styles.totalsValueCol}>
                <Text style={styles.totalDueValue}>{fmt(total, currency)}</Text>
              </Column>
            </Row>

            {/* CTA */}
            <Section style={styles.ctaSection}>
              <Button href={payUrl} style={styles.payButton}>
                Pay Now — {fmt(total, currency)}
              </Button>
            </Section>
...
InvoiceEmail.PreviewProps = {
  ...
  paymentTerms: "Net 30",
  notesFooter:
    "Thank you for your business! Payment via bank transfer or card is accepted.",
  lineItems: [
    {
  ...
  currency: "USD",
  payUrl: "https://craftlyai.app/pay/tok_preview_abc123",
