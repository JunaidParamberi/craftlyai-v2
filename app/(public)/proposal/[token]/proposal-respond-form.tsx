...
interface ProposalRespondFormProps {
  approvalToken: string;
}

type FormStatus = "idle" | "loading" | "approved" | "declined" | "error";

export function ProposalRespondForm({ approvalToken }: ProposalRespondFormProps) {
    ...
    startTransition(async () => {
      try {
        ...
        if (res.ok) {
          ...
          setStatus("error");
          setErrorMessage("This proposal has already been responded to.");
        } else {
